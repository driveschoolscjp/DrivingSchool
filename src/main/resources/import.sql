...
INSERT INTO teachers (id, birthday, email, firstname, gender, inn, lastname, passport, patronymic, tel, photourl, description)
VALUES
  (1, '1961-10-19', 'petrov@gmail.com', 'Nikolay', 'MALE', 34590823, 'Petrov', 'FD459865', 'Igorevich', '097-345-77-32',
   'http://cs621222.vk.me/v621222392/16814/y4UYdX3Jn84.jpg', 'Experience from 1995'),
  (2, '1975-12-15', 'orlov@gmail.com', 'Oleg', 'MALE', 58702314, 'Orlov', 'AC332554', 'Sergeevich', '067-546-56-66',
   'http://cs623717.vk.me/v623717392/2f6a5/buznf0zGKXE.jpg', 'Experience from 2000'),
  (3, '1967-05-21', 'kirylova@gmail.com', 'Alina', 'FEMALE', 98737164, 'Kirylova', 'HH906755', 'Vladimirovna',
   '066-239-00-56', 'http://cs623717.vk.me/v623717392/2f6e4/STlMTziVM8s.jpg', 'Experience from 2011'),
  (4, '1980-01-04', 'denisov@gmail.com', 'Sergey', 'MALE', 94036472, 'Denisov', 'TR435644', 'Nikolaevich',
   '097-560-98-55', 'http://cs623717.vk.me/v623717392/2f6ae/fYc1SRN6ruE.jpg', 'Experience from 2013'),
  (5, '1974-11-17', 'komarova@gmail.com', 'Inna', 'FEMALE', 94522099, 'Komarova', 'AC889078', 'Aleksandrovna',
   '067-465-09-11', 'http://cs623717.vk.me/v623717392/2f6b7/ql8EucirrLk.jpg', 'Experience from 2006'),
  (6, '1969-09-24', 'shvarts@gmail.com', 'Dmitry', 'MALE', 44836109, 'Shvarts', 'GF435564', 'Gavrilovich',
   '050-430-98-65', 'http://cs623717.vk.me/v623717392/2f6c9/WomHgmpSylc.jpg', 'Experience from 2009'),
  (7, '1977-09-16', 'dorognaya@gmail.com', 'Victoria', 'FEMALE', 94776333, 'Dorogaya', 'GT547786', 'Vladislavovna',
   '050-566-78-43', 'http://cs623717.vk.me/v623717392/2f6db/pUNWLYY1HtM.jpg', 'Experience from 2007'),
  (8, '1980-10-16', 'boyko@gmail.com', 'Konstantin', 'MALE', 76819900, 'Boyko', 'DD098897', 'Valerievich',
   '063-540-99-12', 'http://cs623717.vk.me/v623717392/2f693/SvEhrRadwv8.jpg', 'Experience from 2005'),
  (9, '1990-10-11', 'fridman@gmail.com', 'Anna', 'FEMALE', 22091655, 'Fridman', 'FD375946', 'Alekseevna',
   '066-466-78-33', 'http://cs623717.vk.me/v623717392/2f69c/N_NzYco46hE.jpg', 'Experience from 2003'),
  (10, '1988-01-09', 'voropaev@gmail.com', 'Georgy', 'MALE', 34887253, 'Voropaev', 'SD475869', 'Sergeevich',
   '097-569-76-67', 'http://cs623717.vk.me/v623717392/2f6ed/8pwTalSgq9Q.jpg', 'Experience from 2005');
...
VALUES
  (1, '1988-03-19', 'govorov@mail.ru', 'Sergey', 'MALE', 37430098, 'Govorov', 'DR477865', 'Fedorovich', '093-678-09-54',
   'govorov', 'govorov', 10, 1, 1),
  ...
  (32, '1994-12-01', 'lomonosova@mail.ru', 'Maria', 'FEMALE', 44534409, 'Lomonosova', 'HH329054', 'Lvovna',
   '097-536-65-76', 'lomonosova', 'lomonosova', 10, 4, 1),
  (33, '1984-01-05', 'vlasenko@mail.ru', 'Georgy', 'MALE', 19987332, 'Vlasenko', 'JH665498', 'Dmitrievich',
   '095-867-65-45', 'vlasenko', 'vlasenko', 10, 5, 3),
  (34, '1983-01-15', 'zavadsky@mail.ru', 'Petr', 'MALE', 10096453, 'Zavadsky', 'DF547834', 'Kirillovich',
   '098-534-56-67', 'zavadsky', 'zavadsky', 10, 5, 3),
  (35, '1981-04-11', 'litvinenko@mail.ru', 'Maksim', 'MALE', 20990845, 'Litvinenko', 'DD658790', 'Danilovich',
   '068-956-56-66', 'litvinenko', 'litvinenko', 10, 5, 1),
  (36, '1980-08-12', 'vinogradov@mail.ru', 'Evgeny', 'MALE', 20954633, 'Vinogradov', 'KJ985644', 'Olegovich',
   '050-045-66-44', 'vinogradov', 'vinogradov', 10, 5, 2),
  (37, '1985-04-13', 'tsybulenko@mail.ru', 'Elvira', 'FEMALE', 13340998, 'Tsybulenko', 'HJ566745', 'Nikolaevna',
   '098-945-99-88', 'tsybulenko', 'tsybulenko', 10, 5, 2),
  (38, '1984-05-23', 'grigoryeva@mail.ru', 'Olga', 'FEMALE', 22775645, 'Grigoryeva', 'HH657756', 'Vitalyevna',
   '067-745-67-76', 'grigoryeva', 'grigoryeva', 10, 5, 9),
  (39, '1983-08-27', 'vakulenko@mail.ru', 'Nina', 'FEMALE', 22988453, 'Vakulenko', 'DD769877', 'Vladimirovna',
   '067-856-56-54', 'vakulenko', 'vakulenko', 10, 5, 8),
